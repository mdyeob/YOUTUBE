			...
			<ul class="navbar-nav navbar-right  mx-auto">
				<li class="nav-item px-lg-4 dropdown"><a href="#"
					...
					<ul class="dropdown-menu">
						<li class="nav-item px-lg-4  "><a class="nav-link text-uppercase text-expanded" href="login.jsp">로그인</a></li>
						<li class="nav-item px-lg-4 "><a class="nav-link text-uppercase text-expanded" href="join.jsp">회원가입</a></li>
					</ul></li>
			</ul>
			<%
          		} else {
...
<form name="form1" method="post" onSubmit="return false;" class="form1"
	...
	<button id="demo_button" onclick="start()" >
		<img id="start_img" src="img/mic.gif" alt="Start Listening....">
	</button>
...
let keywordIDs = {
	...
	recognition.onresult = function(event) {
		...
		if (search_input.value == "홈"){
			fnList(6);
			search_input.value = '';
		}
		else if ((search_input.value == "뮤직") || (search_input.value == "음악")){
			fnList(0);
			search_input.value = '';
		}
		else if (search_input.value == "스포츠"){
			fnList(1);
			search_input.value = '';
		}
		else if ((search_input.value == "뮤비")  || (search_input.value == "영화")){
			fnList(2);
			search_input.value = '';
		}
		else if (search_input.value == "뉴스"){
			fnList(3);
			search_input.value = '';
		}
		else if (search_input.value == "게임"){
			fnList(4);
			search_input.value = '';
		}
		else if ((search_input.value == "첫 번째") || (search_input.value == "첫 번째 영상")){
			playVideo(0);
			search_input.value = '';
		}
		else if ((search_input.value == "두 번째") || (search_input.value == "두 번째 영상")){
			fnList(8);
			search_input.value = '';
		}
		else if ((search_input.value == "세 번째") || (search_input.value == "세 번째 영상")){
			fnList(9);
			search_input.value = '';
		}
		else if ((search_input.value == "네 번째") || (search_input.value == "네 번째 영상")){
			fnList(10);
			search_input.value = '';
		}
		else if ((search_input.value == "다섯 번째") || (search_input.value == "다섯 번째 영상")){
			fnList(11);
			search_input.value = '';
		}
		else {
